...
static constexpr std::array<VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR, 7> _DeviceFaultAddressTypeKHR_values = {
    VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR::eNone,
    VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR::eReadInvalid,
    VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR::eWriteInvalid,
    VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR::eExecuteInvalid,
    VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR::eInstructionPointerUnknown,
    VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR::eInstructionPointerInvalid,
    VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR::eInstructionPointerFault};

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR>() {
    return _DeviceFaultAddressTypeKHR_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR* enum_values<VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR>() {
    return _DeviceFaultAddressTypeKHR_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR>(VULKAN_HPP_NAMESPACE::DeviceFaultAddressTypeKHR value) {
    return vk::to_string(value);
}

static constexpr std::array<VULKAN_HPP_NAMESPACE::DeviceFaultVendorBinaryHeaderVersionKHR, 1> _DeviceFaultVendorBinaryHeaderVersionKHR_values = {
    VULKAN_HPP_NAMESPACE::DeviceFaultVendorBinaryHeaderVersionKHR::eOne};

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::DeviceFaultVendorBinaryHeaderVersionKHR>() {
    return _DeviceFaultVendorBinaryHeaderVersionKHR_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::DeviceFaultVendorBinaryHeaderVersionKHR* enum_values<VULKAN_HPP_NAMESPACE::DeviceFaultVendorBinaryHeaderVersionKHR>() {
    return _DeviceFaultVendorBinaryHeaderVersionKHR_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::DeviceFaultVendorBinaryHeaderVersionKHR>(VULKAN_HPP_NAMESPACE::DeviceFaultVendorBinaryHeaderVersionKHR value) {
    return vk::to_string(value);
}
...
static constexpr std::array<VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM, 4> _PerfHintTypeQCOM_values = {
    VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM::eDefault,
    VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM::eFrequencyMin,
    VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM::eFrequencyMax,
    VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM::eFrequencyScaled};

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM>() {
    return _PerfHintTypeQCOM_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM* enum_values<VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM>() {
    return _PerfHintTypeQCOM_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM>(VULKAN_HPP_NAMESPACE::PerfHintTypeQCOM value) {
    return vk::to_string(value);
}

static constexpr std::array<VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC, 3> _ThrottleHintTypeSEC_values = {
    VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC::eDefault,
    VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC::eLow,
    VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC::eHigh};

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC>() {
    return _ThrottleHintTypeSEC_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC* enum_values<VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC>() {
    return _ThrottleHintTypeSEC_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC>(VULKAN_HPP_NAMESPACE::ThrottleHintTypeSEC value) {
    return vk::to_string(value);
}
...
static constexpr std::array<VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM, 2> _DataGraphTOSALevelARM_values = {
    VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM::eNone,
    VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM::e8K};

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM>() {
    return _DataGraphTOSALevelARM_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM* enum_values<VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM>() {
    return _DataGraphTOSALevelARM_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM>(VULKAN_HPP_NAMESPACE::DataGraphTOSALevelARM value) {
    return vk::to_string(value);
}

static constexpr std::array<VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM, 4> _DataGraphOpticalFlowPerformanceLevelARM_values = {
    VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM::eUnknown,
    VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM::eSlow,
    VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM::eMedium,
    VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM::eFast};

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM>() {
    return _DataGraphOpticalFlowPerformanceLevelARM_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM* enum_values<VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM>() {
    return _DataGraphOpticalFlowPerformanceLevelARM_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM>(VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowPerformanceLevelARM value) {
    return vk::to_string(value);
}

static constexpr std::array<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeConnectionTypeARM, 0> _DataGraphPipelineNodeConnectionTypeARM_values = {
    };

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeConnectionTypeARM>() {
    return _DataGraphPipelineNodeConnectionTypeARM_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeConnectionTypeARM* enum_values<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeConnectionTypeARM>() {
    return _DataGraphPipelineNodeConnectionTypeARM_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeConnectionTypeARM>(VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeConnectionTypeARM value) {
    return vk::to_string(value);
}

static constexpr std::array<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeTypeARM, 0> _DataGraphPipelineNodeTypeARM_values = {
    };

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeTypeARM>() {
    return _DataGraphPipelineNodeTypeARM_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeTypeARM* enum_values<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeTypeARM>() {
    return _DataGraphPipelineNodeTypeARM_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeTypeARM>(VULKAN_HPP_NAMESPACE::DataGraphPipelineNodeTypeARM value) {
    return vk::to_string(value);
}

static constexpr std::array<VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM, 3> _NeuralAcceleratorStatisticsModeARM_values = {
    VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM::eDisabled,
    VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM::eStatistics0,
    VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM::eStatistics1};

template<> uint32_t enum_size<VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM>() {
    return _NeuralAcceleratorStatisticsModeARM_values.size();
}

template<> const VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM* enum_values<VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM>() {
    return _NeuralAcceleratorStatisticsModeARM_values.data();
}

template<> std::string enum_to_string<VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM>(VULKAN_HPP_NAMESPACE::NeuralAcceleratorStatisticsModeARM value) {
    return vk::to_string(value);
}
