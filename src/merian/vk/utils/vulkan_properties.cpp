...
VulkanProperties::VulkanProperties(const vk::PhysicalDevice& physical_device,
    ...
    if (extensions.contains(VK_KHR_DEVICE_FAULT_EXTENSION_NAME)) {
        m_fault_properties_khr.pNext = chain_tail;
        chain_tail = &m_fault_properties_khr;
        available_structs.insert(m_fault_properties_khr.sType);
    }
    ...
    if (extensions.contains(VK_QCOM_QUEUE_PERF_HINT_EXTENSION_NAME)) {
        m_queue_perf_hint_properties_qcom.pNext = chain_tail;
        chain_tail = &m_queue_perf_hint_properties_qcom;
        available_structs.insert(m_queue_perf_hint_properties_qcom.sType);
    }
    ...
    if (extensions.contains(VK_ARM_SCHEDULING_CONTROLS_EXTENSION_NAME)) {
        m_scheduling_controls_dispatch_parameters_properties_arm.pNext = chain_tail;
        chain_tail = &m_scheduling_controls_dispatch_parameters_properties_arm;
        available_structs.insert(m_scheduling_controls_dispatch_parameters_properties_arm.sType);
    }
    ...
    if (extensions.contains(VK_KHR_SHADER_ABORT_EXTENSION_NAME)) {
        m_shader_abort_properties_khr.pNext = chain_tail;
        chain_tail = &m_shader_abort_properties_khr;
        available_structs.insert(m_shader_abort_properties_khr.sType);
    }
    ...
    if (extensions.contains(VK_ARM_SHADER_INSTRUMENTATION_EXTENSION_NAME)) {
        m_shader_instrumentation_properties_arm.pNext = chain_tail;
        chain_tail = &m_shader_instrumentation_properties_arm;
        available_structs.insert(m_shader_instrumentation_properties_arm.sType);
    }
...
template const vk::PhysicalDeviceFaultPropertiesKHR& VulkanProperties::get<vk::PhysicalDeviceFaultPropertiesKHR>() const;
...
template const vk::PhysicalDeviceQueuePerfHintPropertiesQCOM& VulkanProperties::get<vk::PhysicalDeviceQueuePerfHintPropertiesQCOM>() const;
...
template const vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM& VulkanProperties::get<vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM>() const;
...
template const vk::PhysicalDeviceShaderAbortPropertiesKHR& VulkanProperties::get<vk::PhysicalDeviceShaderAbortPropertiesKHR>() const;
...
template const vk::PhysicalDeviceShaderInstrumentationPropertiesARM& VulkanProperties::get<vk::PhysicalDeviceShaderInstrumentationPropertiesARM>() const;
...
const vk::PhysicalDeviceFaultPropertiesKHR& VulkanProperties::get_fault_properties_khr() const {
    assert(is_available(vk::StructureType::ePhysicalDeviceFaultPropertiesKHR));
    return m_fault_properties_khr;
}
VulkanProperties::operator const vk::PhysicalDeviceFaultPropertiesKHR&() const {
    return get_fault_properties_khr();
}
...
const vk::PhysicalDeviceQueuePerfHintPropertiesQCOM& VulkanProperties::get_queue_perf_hint_properties_qcom() const {
    assert(is_available(vk::StructureType::ePhysicalDeviceQueuePerfHintPropertiesQCOM));
    return m_queue_perf_hint_properties_qcom;
}
VulkanProperties::operator const vk::PhysicalDeviceQueuePerfHintPropertiesQCOM&() const {
    return get_queue_perf_hint_properties_qcom();
}
...
const vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM& VulkanProperties::get_scheduling_controls_dispatch_parameters_properties_arm() const {
    assert(is_available(vk::StructureType::ePhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM));
    return m_scheduling_controls_dispatch_parameters_properties_arm;
}
VulkanProperties::operator const vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM&() const {
    return get_scheduling_controls_dispatch_parameters_properties_arm();
}
...
const vk::PhysicalDeviceShaderAbortPropertiesKHR& VulkanProperties::get_shader_abort_properties_khr() const {
    assert(is_available(vk::StructureType::ePhysicalDeviceShaderAbortPropertiesKHR));
    return m_shader_abort_properties_khr;
}
VulkanProperties::operator const vk::PhysicalDeviceShaderAbortPropertiesKHR&() const {
    return get_shader_abort_properties_khr();
}
...
const vk::PhysicalDeviceShaderInstrumentationPropertiesARM& VulkanProperties::get_shader_instrumentation_properties_arm() const {
    assert(is_available(vk::StructureType::ePhysicalDeviceShaderInstrumentationPropertiesARM));
    return m_shader_instrumentation_properties_arm;
}
VulkanProperties::operator const vk::PhysicalDeviceShaderInstrumentationPropertiesARM&() const {
    return get_shader_instrumentation_properties_arm();
}
...
const vk::PhysicalDeviceCopyMemoryIndirectPropertiesKHR& VulkanProperties::get_copy_memory_indirect_properties_nv() const {
    return get_copy_memory_indirect_properties_khr();  // Alias for PhysicalDeviceCopyMemoryIndirectPropertiesKHR
}
const vk::PhysicalDeviceDepthStencilResolveProperties& VulkanProperties::get_depth_stencil_resolve_properties_khr() const {
    return get_depth_stencil_resolve_properties();  // Alias for PhysicalDeviceDepthStencilResolveProperties
}
const vk::PhysicalDeviceDescriptorIndexingProperties& VulkanProperties::get_descriptor_indexing_properties_ext() const {
    return get_descriptor_indexing_properties();  // Alias for PhysicalDeviceDescriptorIndexingProperties
}
const vk::PhysicalDeviceDriverProperties& VulkanProperties::get_driver_properties_khr() const {
    return get_driver_properties();  // Alias for PhysicalDeviceDriverProperties
}
const vk::PhysicalDeviceFloatControlsProperties& VulkanProperties::get_float_controls_properties_khr() const {
    return get_float_controls_properties();  // Alias for PhysicalDeviceFloatControlsProperties
}
const vk::PhysicalDeviceFragmentDensityMapOffsetPropertiesEXT& VulkanProperties::get_fragment_density_map_offset_properties_qcom() const {
    return get_fragment_density_map_offset_properties_ext();  // Alias for PhysicalDeviceFragmentDensityMapOffsetPropertiesEXT
}
const vk::PhysicalDeviceHostImageCopyProperties& VulkanProperties::get_host_image_copy_properties_ext() const {
    return get_host_image_copy_properties();  // Alias for PhysicalDeviceHostImageCopyProperties
}
const vk::PhysicalDeviceIDProperties& VulkanProperties::get_id_properties_khr() const {
    return get_id_properties();  // Alias for PhysicalDeviceIDProperties
}
const vk::PhysicalDeviceInlineUniformBlockProperties& VulkanProperties::get_inline_uniform_block_properties_ext() const {
    return get_inline_uniform_block_properties();  // Alias for PhysicalDeviceInlineUniformBlockProperties
}
const vk::PhysicalDeviceLineRasterizationProperties& VulkanProperties::get_line_rasterization_properties_khr() const {
    return get_line_rasterization_properties();  // Alias for PhysicalDeviceLineRasterizationProperties
}
...
const vk::PhysicalDeviceShaderIntegerDotProductProperties& VulkanProperties::get_shader_integer_dot_product_properties_khr() const {
    return get_shader_integer_dot_product_properties();  // Alias for PhysicalDeviceShaderIntegerDotProductProperties
}
const vk::PhysicalDeviceSubgroupSizeControlProperties& VulkanProperties::get_subgroup_size_control_properties_ext() const {
    return get_subgroup_size_control_properties();  // Alias for PhysicalDeviceSubgroupSizeControlProperties
}
const vk::PhysicalDeviceTexelBufferAlignmentProperties& VulkanProperties::get_texel_buffer_alignment_properties_ext() const {
    return get_texel_buffer_alignment_properties();  // Alias for PhysicalDeviceTexelBufferAlignmentProperties
}
const vk::PhysicalDeviceTimelineSemaphoreProperties& VulkanProperties::get_timeline_semaphore_properties_khr() const {
    return get_timeline_semaphore_properties();  // Alias for PhysicalDeviceTimelineSemaphoreProperties
}
const vk::PhysicalDeviceVertexAttributeDivisorProperties& VulkanProperties::get_vertex_attribute_divisor_properties_khr() const {
    return get_vertex_attribute_divisor_properties();  // Alias for PhysicalDeviceVertexAttributeDivisorProperties
}
...
const void* VulkanProperties::get_struct_ptr(vk::StructureType stype) const {
    switch (stype) {
        ...
        case vk::StructureType::ePhysicalDeviceExternalMemoryHostPropertiesEXT:
            return &m_external_memory_host_properties_ext;
        case vk::StructureType::ePhysicalDeviceFaultPropertiesKHR:
            return &m_fault_properties_khr;
        ...
        case vk::StructureType::ePhysicalDevicePushDescriptorProperties:
            return &m_push_descriptor_properties;
        case vk::StructureType::ePhysicalDeviceQueuePerfHintPropertiesQCOM:
            return &m_queue_perf_hint_properties_qcom;
        ...
        case vk::StructureType::ePhysicalDeviceSamplerFilterMinmaxProperties:
            return &m_sampler_filter_minmax_properties;
        case vk::StructureType::ePhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM:
            return &m_scheduling_controls_dispatch_parameters_properties_arm;
        case vk::StructureType::ePhysicalDeviceSchedulingControlsPropertiesARM:
            return &m_scheduling_controls_properties_arm;
        case vk::StructureType::ePhysicalDeviceShaderAbortPropertiesKHR:
            return &m_shader_abort_properties_khr;
        ...
        case vk::StructureType::ePhysicalDeviceShaderCorePropertiesARM:
            return &m_shader_core_properties_arm;
        case vk::StructureType::ePhysicalDeviceShaderInstrumentationPropertiesARM:
            return &m_shader_instrumentation_properties_arm;
