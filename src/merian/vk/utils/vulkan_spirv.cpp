...
const std::unordered_map<std::string_view, SpirvExtReq> spirv_ext_req_map = {
    ...
    {"SPV_KHR_abort", {0, {VK_KHR_SHADER_ABORT_EXTENSION_NAME}}},
    ...
    {"SPV_KHR_constant_data", {0, {VK_KHR_SHADER_CONSTANT_DATA_EXTENSION_NAME}}},
    ...
    {"SPV_QCOM_cooperative_matrix_conversion", {0, {VK_QCOM_COOPERATIVE_MATRIX_CONVERSION_EXTENSION_NAME}}},
    ...
    {"SPV_VALVE_mixed_float_dot_product", {0, {VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME}}},
};
} // namespace
...
// AbortKHR
bool check_capability_AbortKHR(
    ...
    // Enable: requires (VK_KHR_shader_abort)
    if (enabled_extensions.contains(VK_KHR_SHADER_ABORT_EXTENSION_NAME)) {
        if (features.get_feature("shaderAbort")) {
            return true;
        }
    }
...
// ConstantDataKHR
bool check_capability_ConstantDataKHR(
    [[maybe_unused]] uint32_t vk_api_version,
    [[maybe_unused]] const std::unordered_set<std::string>& enabled_extensions,
    [[maybe_unused]] const VulkanFeatures& features,
    [[maybe_unused]] const VulkanProperties& properties) {

    // Enable: requires (VK_KHR_shader_constant_data)
    if (enabled_extensions.contains(VK_KHR_SHADER_CONSTANT_DATA_EXTENSION_NAME)) {
        if (features.get_feature("shaderConstantData")) {
            return true;
        }
    }
...
// DotProductBFloat16AccVALVE
bool check_capability_DotProductBFloat16AccVALVE(
    [[maybe_unused]] uint32_t vk_api_version,
    [[maybe_unused]] const std::unordered_set<std::string>& enabled_extensions,
    [[maybe_unused]] const VulkanFeatures& features,
    [[maybe_unused]] const VulkanProperties& properties) {

    // Enable: requires (VK_VALVE_shader_mixed_float_dot_product)
    if (enabled_extensions.contains(VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME)) {
        if (features.get_feature("shaderMixedFloatDotProductBFloat16Acc")) {
            return true;
        }
    }
...
// DotProductFloat16AccFloat16VALVE
bool check_capability_DotProductFloat16AccFloat16VALVE(
    [[maybe_unused]] uint32_t vk_api_version,
    [[maybe_unused]] const std::unordered_set<std::string>& enabled_extensions,
    [[maybe_unused]] const VulkanFeatures& features,
    [[maybe_unused]] const VulkanProperties& properties) {
    ...
    // Enable: requires (VK_VALVE_shader_mixed_float_dot_product)
    if (enabled_extensions.contains(VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME)) {
        if (features.get_feature("shaderMixedFloatDotProductFloat16AccFloat16")) {
            return true;
        }
    }
...
// DotProductFloat16AccFloat32VALVE
bool check_capability_DotProductFloat16AccFloat32VALVE(
    [[maybe_unused]] uint32_t vk_api_version,
    [[maybe_unused]] const std::unordered_set<std::string>& enabled_extensions,
    [[maybe_unused]] const VulkanFeatures& features,
    [[maybe_unused]] const VulkanProperties& properties) {
    ...
    // Enable: requires (VK_VALVE_shader_mixed_float_dot_product)
    if (enabled_extensions.contains(VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME)) {
        if (features.get_feature("shaderMixedFloatDotProductFloat16AccFloat32")) {
            return true;
        }
    }
...
// DotProductFloat8AccFloat32VALVE
bool check_capability_DotProductFloat8AccFloat32VALVE(
    [[maybe_unused]] uint32_t vk_api_version,
    [[maybe_unused]] const std::unordered_set<std::string>& enabled_extensions,
    [[maybe_unused]] const VulkanFeatures& features,
    [[maybe_unused]] const VulkanProperties& properties) {
    ...
    // Enable: requires (VK_VALVE_shader_mixed_float_dot_product)
    if (enabled_extensions.contains(VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME)) {
        if (features.get_feature("shaderMixedFloatDotProductFloat8AccFloat32")) {
            return true;
        }
    }
...
const std::unordered_map<std::string_view, CapCheckFn> capability_check_map = {
    {"AbortKHR", check_capability_AbortKHR},
    ...
    {"ComputeDerivativeGroupLinearNV", check_capability_ComputeDerivativeGroupLinearKHR},
    {"ComputeDerivativeGroupQuadsKHR", check_capability_ComputeDerivativeGroupQuadsKHR},
    {"ComputeDerivativeGroupQuadsNV", check_capability_ComputeDerivativeGroupQuadsKHR},
    {"ConstantDataKHR", check_capability_ConstantDataKHR},
    ...
    {"DemoteToHelperInvocationEXT", check_capability_DemoteToHelperInvocation},
    ...
    {"DotProductBFloat16AccVALVE", check_capability_DotProductBFloat16AccVALVE},
    {"DotProductFloat16AccFloat16VALVE", check_capability_DotProductFloat16AccFloat16VALVE},
    {"DotProductFloat16AccFloat32VALVE", check_capability_DotProductFloat16AccFloat32VALVE},
    {"DotProductFloat8AccFloat32VALVE", check_capability_DotProductFloat8AccFloat32VALVE},
    {"DotProductInput4x8Bit", check_capability_DotProductInput4x8Bit},
    {"DotProductInput4x8BitKHR", check_capability_DotProductInput4x8Bit},
    {"DotProductInput4x8BitPacked", check_capability_DotProductInput4x8BitPacked},
    {"DotProductInput4x8BitPackedKHR", check_capability_DotProductInput4x8BitPacked},
    {"DotProductInputAll", check_capability_DotProductInputAll},
    {"DotProductInputAllKHR", check_capability_DotProductInputAll},
    {"DotProductKHR", check_capability_DotProduct},
    ...
    {"FragmentBarycentricNV", check_capability_FragmentBarycentricKHR},
    ...
    {"GroupNonUniformPartitionedNV", check_capability_GroupNonUniformPartitionedEXT},
    ...
    {"InputAttachmentArrayDynamicIndexingEXT", check_capability_InputAttachmentArrayDynamicIndexing},
    {"InputAttachmentArrayNonUniformIndexing", check_capability_InputAttachmentArrayNonUniformIndexing},
    {"InputAttachmentArrayNonUniformIndexingEXT", check_capability_InputAttachmentArrayNonUniformIndexing},
    ...
    {"PhysicalStorageBufferAddressesEXT", check_capability_PhysicalStorageBufferAddresses},
    ...
    {"RuntimeDescriptorArrayEXT", check_capability_RuntimeDescriptorArray},
    ...
    {"SampledImageArrayNonUniformIndexingEXT", check_capability_SampledImageArrayNonUniformIndexing},
    ...
    {"ShaderNonUniformEXT", check_capability_ShaderNonUniform},
    ...
    {"ShaderViewportIndexLayerNV", check_capability_ShaderViewportIndexLayerEXT},
    {"ShaderViewportMaskNV", check_capability_ShaderViewportMaskNV},
    {"ShadingRateNV", check_capability_FragmentDensityEXT},
    ...
    {"StorageBufferArrayNonUniformIndexingEXT", check_capability_StorageBufferArrayNonUniformIndexing},
    ...
    {"StorageImageArrayNonUniformIndexingEXT", check_capability_StorageImageArrayNonUniformIndexing},
    ...
    {"StorageTexelBufferArrayDynamicIndexingEXT", check_capability_StorageTexelBufferArrayDynamicIndexing},
    {"StorageTexelBufferArrayNonUniformIndexing", check_capability_StorageTexelBufferArrayNonUniformIndexing},
    {"StorageTexelBufferArrayNonUniformIndexingEXT", check_capability_StorageTexelBufferArrayNonUniformIndexing},
    {"StorageUniform16", check_capability_UniformAndStorageBuffer16BitAccess},
    {"StorageUniformBufferBlock16", check_capability_StorageBuffer16BitAccess},
    ...
    {"UniformBufferArrayNonUniformIndexingEXT", check_capability_UniformBufferArrayNonUniformIndexing},
    {"UniformTexelBufferArrayDynamicIndexing", check_capability_UniformTexelBufferArrayDynamicIndexing},
    {"UniformTexelBufferArrayDynamicIndexingEXT", check_capability_UniformTexelBufferArrayDynamicIndexing},
    {"UniformTexelBufferArrayNonUniformIndexing", check_capability_UniformTexelBufferArrayNonUniformIndexing},
    {"UniformTexelBufferArrayNonUniformIndexingEXT", check_capability_UniformTexelBufferArrayNonUniformIndexing},
    ...
    {"VulkanMemoryModelDeviceScopeKHR", check_capability_VulkanMemoryModelDeviceScope},
    {"VulkanMemoryModelKHR", check_capability_VulkanMemoryModel},
...
const std::unordered_map<std::string_view, std::vector<CapExtEntry>> cap_ext_map = {
    {"AbortKHR", {{VK_KHR_SHADER_ABORT_EXTENSION_NAME, 0}}},
    ...
    {"ComputeDerivativeGroupLinearNV", {{VK_KHR_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME, 0}, {VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME, 0}}},
    ...
    {"ComputeDerivativeGroupQuadsNV", {{VK_KHR_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME, 0}, {VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME, 0}}},
    {"ConstantDataKHR", {{VK_KHR_SHADER_CONSTANT_DATA_EXTENSION_NAME, 0}}},
    ...
    {"DemoteToHelperInvocationEXT", {{VK_EXT_SHADER_DEMOTE_TO_HELPER_INVOCATION_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    ...
    {"DotProductKHR", {{VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    {"DotProductBFloat16AccVALVE", {{VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME, 0}}},
    {"DotProductFloat16AccFloat16VALVE", {{VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME, 0}}},
    {"DotProductFloat16AccFloat32VALVE", {{VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME, 0}}},
    {"DotProductFloat8AccFloat32VALVE", {{VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME, 0}}},
    {"DotProductInput4x8Bit", {{VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    {"DotProductInput4x8BitKHR", {{VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    {"DotProductInput4x8BitPacked", {{VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    {"DotProductInput4x8BitPackedKHR", {{VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    {"DotProductInputAll", {{VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    {"DotProductInputAllKHR", {{VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME, VK_API_VERSION_1_3}}},
    ...
    {"FragmentBarycentricNV", {{VK_KHR_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME, 0}, {VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME, 0}}},
    {"FragmentDensityEXT", {{VK_EXT_FRAGMENT_DENSITY_MAP_EXTENSION_NAME, 0}, {VK_NV_SHADING_RATE_IMAGE_EXTENSION_NAME, 0}}},
    {"ShadingRateNV", {{VK_EXT_FRAGMENT_DENSITY_MAP_EXTENSION_NAME, 0}, {VK_NV_SHADING_RATE_IMAGE_EXTENSION_NAME, 0}}},
    ...
    {"GroupNonUniformPartitionedNV", {{VK_EXT_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME, 0}, {VK_NV_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME, 0}}},
    ...
    {"InputAttachmentArrayDynamicIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"InputAttachmentArrayNonUniformIndexing", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"InputAttachmentArrayNonUniformIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    ...
    {"PhysicalStorageBufferAddressesEXT", {{VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME, VK_API_VERSION_1_2}, {VK_EXT_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME, 0}}},
    ...
    {"RuntimeDescriptorArrayEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    ...
    {"SampledImageArrayNonUniformIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    ...
    {"ShaderNonUniformEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, 0}}},
    ...
    {"ShaderViewportIndexLayerNV", {{VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME, 0}, {VK_NV_VIEWPORT_ARRAY_2_EXTENSION_NAME, 0}}},
    ...
    {"StorageUniformBufferBlock16", {{VK_KHR_16BIT_STORAGE_EXTENSION_NAME, 0}}},
    ...
    {"StorageBufferArrayNonUniformIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"StorageImageArrayNonUniformIndexing", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"StorageImageArrayNonUniformIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    ...
    {"StorageTexelBufferArrayDynamicIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"StorageTexelBufferArrayNonUniformIndexing", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"StorageTexelBufferArrayNonUniformIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    ...
    {"StorageUniform16", {{VK_KHR_16BIT_STORAGE_EXTENSION_NAME, 0}}},
    ...
    {"UniformBufferArrayNonUniformIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"UniformTexelBufferArrayDynamicIndexing", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"UniformTexelBufferArrayDynamicIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"UniformTexelBufferArrayNonUniformIndexing", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"UniformTexelBufferArrayNonUniformIndexingEXT", {{VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    ...
    {"VulkanMemoryModelKHR", {{VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"VulkanMemoryModelDeviceScope", {{VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME, VK_API_VERSION_1_2}}},
    {"VulkanMemoryModelDeviceScopeKHR", {{VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME, VK_API_VERSION_1_2}}},
...
const std::unordered_map<std::string_view, std::vector<const char*>> cap_feature_map = {
    ...
    {"ConstantDataKHR", {"shaderConstantData"}},
    ...
    {"DotProductKHR", {"shaderIntegerDotProduct"}},
    {"DotProductBFloat16AccVALVE", {"shaderMixedFloatDotProductBFloat16Acc"}},
    {"DotProductFloat16AccFloat16VALVE", {"shaderMixedFloatDotProductFloat16AccFloat16"}},
    {"DotProductFloat16AccFloat32VALVE", {"shaderMixedFloatDotProductFloat16AccFloat32"}},
    {"DotProductFloat8AccFloat32VALVE", {"shaderMixedFloatDotProductFloat8AccFloat32"}},
    {"DotProductInput4x8Bit", {"shaderIntegerDotProduct"}},
    {"DotProductInput4x8BitKHR", {"shaderIntegerDotProduct"}},
    {"DotProductInput4x8BitPacked", {"shaderIntegerDotProduct"}},
    {"DotProductInput4x8BitPackedKHR", {"shaderIntegerDotProduct"}},
    {"DotProductInputAll", {"shaderIntegerDotProduct"}},
    {"DotProductInputAllKHR", {"shaderIntegerDotProduct"}},
    ...
    {"ShadingRateNV", {"fragmentDensityMap", "shadingRateImage"}},
    ...
    {"GroupNonUniformPartitionedNV", {"shaderSubgroupPartitioned"}},
    ...
    {"PhysicalStorageBufferAddressesEXT", {"bufferDeviceAddress"}},
