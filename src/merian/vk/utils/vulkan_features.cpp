// This file was autogenerated for Vulkan v1.4.350.
...
VulkanFeatures::VulkanFeatures(const vk::PhysicalDevice& physical_device,
    ...
    if (device_extensions.contains(VK_ARM_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_EXTENSION_NAME)) {
        m_data_graph_neural_accelerator_statistics_features_arm.pNext = feat_p_next;
        feat_p_next = &m_data_graph_neural_accelerator_statistics_features_arm;
    }

    // PhysicalDeviceDataGraphOpticalFlowFeaturesARM
    if (device_extensions.contains(VK_ARM_DATA_GRAPH_OPTICAL_FLOW_EXTENSION_NAME)) {
        m_data_graph_optical_flow_features_arm.pNext = feat_p_next;
        feat_p_next = &m_data_graph_optical_flow_features_arm;
    }
    ...
    if (device_extensions.contains(VK_KHR_DEVICE_ADDRESS_COMMANDS_EXTENSION_NAME)) {
        m_device_address_commands_features_khr.pNext = feat_p_next;
        feat_p_next = &m_device_address_commands_features_khr;
    }
    ...
    if (device_extensions.contains(VK_KHR_DEVICE_FAULT_EXTENSION_NAME)) {
        m_fault_features_khr.pNext = feat_p_next;
        feat_p_next = &m_fault_features_khr;
    }
    ...
    if (device_extensions.contains(VK_KHR_MAINTENANCE_11_EXTENSION_NAME)) {
        m_maintenance11_features_khr.pNext = feat_p_next;
        feat_p_next = &m_maintenance11_features_khr;
    }
    ...
    if (device_extensions.contains(VK_NV_PRESENT_METERING_EXTENSION_NAME)) {
        m_present_metering_features_nv.pNext = feat_p_next;
        feat_p_next = &m_present_metering_features_nv;
    }
    ...
    if (device_extensions.contains(VK_EXT_PRIMITIVE_RESTART_INDEX_EXTENSION_NAME)) {
        m_primitive_restart_index_features_ext.pNext = feat_p_next;
        feat_p_next = &m_primitive_restart_index_features_ext;
    }
    ...
    if (device_extensions.contains(VK_QCOM_QUEUE_PERF_HINT_EXTENSION_NAME)) {
        m_queue_perf_hint_features_qcom.pNext = feat_p_next;
        feat_p_next = &m_queue_perf_hint_features_qcom;
    }
    ...
    if (device_extensions.contains(VK_KHR_SHADER_ABORT_EXTENSION_NAME)) {
        m_shader_abort_features_khr.pNext = feat_p_next;
        feat_p_next = &m_shader_abort_features_khr;
    }
    ...
    if (device_extensions.contains(VK_KHR_SHADER_CONSTANT_DATA_EXTENSION_NAME)) {
        m_shader_constant_data_features_khr.pNext = feat_p_next;
        feat_p_next = &m_shader_constant_data_features_khr;
    }
    ...
    if (device_extensions.contains(VK_ARM_SHADER_INSTRUMENTATION_EXTENSION_NAME)) {
        m_shader_instrumentation_features_arm.pNext = feat_p_next;
        feat_p_next = &m_shader_instrumentation_features_arm;
    }
    ...
    if (device_extensions.contains(VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME)) {
        m_shader_mixed_float_dot_product_features_valve.pNext = feat_p_next;
        feat_p_next = &m_shader_mixed_float_dot_product_features_valve;
    }
    ...
    if (device_extensions.contains(VK_SEC_THROTTLE_HINT_EXTENSION_NAME)) {
        m_throttle_hint_features_sec.pNext = feat_p_next;
        feat_p_next = &m_throttle_hint_features_sec;
    }
    ...
    // Sync deviceFault with all 2 structs that provide the feature.
    const VkBool32 deviceFault_value = m_fault_features_ext.deviceFault || m_fault_features_khr.deviceFault;
    m_fault_features_ext.deviceFault = deviceFault_value;
    m_fault_features_khr.deviceFault = deviceFault_value;

    // Sync deviceFaultVendorBinary with all 2 structs that provide the feature.
    const VkBool32 deviceFaultVendorBinary_value = m_fault_features_ext.deviceFaultVendorBinary || m_fault_features_khr.deviceFaultVendorBinary;
    m_fault_features_ext.deviceFaultVendorBinary = deviceFaultVendorBinary_value;
    m_fault_features_khr.deviceFaultVendorBinary = deviceFaultVendorBinary_value;
...
std::vector<std::string> VulkanFeatures::get_enabled_features() const {
    ...
    if (m_data_graph_neural_accelerator_statistics_features_arm.dataGraphNeuralAcceleratorStatistics == VK_TRUE) enabled.push_back("dataGraphNeuralAcceleratorStatistics");
    if (m_data_graph_optical_flow_features_arm.dataGraphOpticalFlow == VK_TRUE) enabled.push_back("dataGraphOpticalFlow");
    ...
    if (m_device_address_commands_features_khr.deviceAddressCommands == VK_TRUE) enabled.push_back("deviceAddressCommands");
    ...
    if (m_fault_features_khr.deviceFaultDeviceLostOnMasked == VK_TRUE) enabled.push_back("deviceFaultDeviceLostOnMasked");
    if (m_fault_features_khr.deviceFaultReportMasked == VK_TRUE) enabled.push_back("deviceFaultReportMasked");
    ...
    if (m_maintenance11_features_khr.maintenance11 == VK_TRUE) enabled.push_back("maintenance11");
    ...
    if (m_present_metering_features_nv.presentMetering == VK_TRUE) enabled.push_back("presentMetering");
    ...
    if (m_primitive_restart_index_features_ext.primitiveRestartIndex == VK_TRUE) enabled.push_back("primitiveRestartIndex");
    ...
    if (m_queue_perf_hint_features_qcom.queuePerfHint == VK_TRUE) enabled.push_back("queuePerfHint");
    ...
    if (m_shader_abort_features_khr.shaderAbort == VK_TRUE) enabled.push_back("shaderAbort");
    ...
    if (m_shader_constant_data_features_khr.shaderConstantData == VK_TRUE) enabled.push_back("shaderConstantData");
    ...
    if (m_shader_instrumentation_features_arm.shaderInstrumentation == VK_TRUE) enabled.push_back("shaderInstrumentation");
    ...
    if (m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductBFloat16Acc == VK_TRUE) enabled.push_back("shaderMixedFloatDotProductBFloat16Acc");
    if (m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat16 == VK_TRUE) enabled.push_back("shaderMixedFloatDotProductFloat16AccFloat16");
    if (m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat32 == VK_TRUE) enabled.push_back("shaderMixedFloatDotProductFloat16AccFloat32");
    if (m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat8AccFloat32 == VK_TRUE) enabled.push_back("shaderMixedFloatDotProductFloat8AccFloat32");
    ...
    if (m_throttle_hint_features_sec.throttleHint == VK_TRUE) enabled.push_back("throttleHint");
...
template const vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM& VulkanFeatures::get<vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM>() const;
template const vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM& VulkanFeatures::get<vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM>() const;
...
template const vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR& VulkanFeatures::get<vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR>() const;
...
template const vk::PhysicalDeviceFaultFeaturesKHR& VulkanFeatures::get<vk::PhysicalDeviceFaultFeaturesKHR>() const;
...
template const vk::PhysicalDeviceMaintenance11FeaturesKHR& VulkanFeatures::get<vk::PhysicalDeviceMaintenance11FeaturesKHR>() const;
...
template const vk::PhysicalDevicePresentMeteringFeaturesNV& VulkanFeatures::get<vk::PhysicalDevicePresentMeteringFeaturesNV>() const;
...
template const vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT& VulkanFeatures::get<vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT>() const;
...
template const vk::PhysicalDeviceQueuePerfHintFeaturesQCOM& VulkanFeatures::get<vk::PhysicalDeviceQueuePerfHintFeaturesQCOM>() const;
...
template const vk::PhysicalDeviceShaderAbortFeaturesKHR& VulkanFeatures::get<vk::PhysicalDeviceShaderAbortFeaturesKHR>() const;
...
template const vk::PhysicalDeviceShaderConstantDataFeaturesKHR& VulkanFeatures::get<vk::PhysicalDeviceShaderConstantDataFeaturesKHR>() const;
...
template const vk::PhysicalDeviceShaderInstrumentationFeaturesARM& VulkanFeatures::get<vk::PhysicalDeviceShaderInstrumentationFeaturesARM>() const;
...
template const vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE& VulkanFeatures::get<vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE>() const;
...
template const vk::PhysicalDeviceThrottleHintFeaturesSEC& VulkanFeatures::get<vk::PhysicalDeviceThrottleHintFeaturesSEC>() const;
...
const vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM& VulkanFeatures::get_data_graph_neural_accelerator_statistics_features_arm() const {
    return m_data_graph_neural_accelerator_statistics_features_arm;
}
VulkanFeatures::operator const vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM&() const {
    return m_data_graph_neural_accelerator_statistics_features_arm;
}
const vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM& VulkanFeatures::get_data_graph_optical_flow_features_arm() const {
    return m_data_graph_optical_flow_features_arm;
}
VulkanFeatures::operator const vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM&() const {
    return m_data_graph_optical_flow_features_arm;
}
...
const vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR& VulkanFeatures::get_device_address_commands_features_khr() const {
    return m_device_address_commands_features_khr;
}
VulkanFeatures::operator const vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR&() const {
    return m_device_address_commands_features_khr;
}
...
const vk::PhysicalDeviceFaultFeaturesKHR& VulkanFeatures::get_fault_features_khr() const {
    return m_fault_features_khr;
}
VulkanFeatures::operator const vk::PhysicalDeviceFaultFeaturesKHR&() const {
    return m_fault_features_khr;
}
...
const vk::PhysicalDeviceMaintenance11FeaturesKHR& VulkanFeatures::get_maintenance11_features_khr() const {
    return m_maintenance11_features_khr;
}
VulkanFeatures::operator const vk::PhysicalDeviceMaintenance11FeaturesKHR&() const {
    return m_maintenance11_features_khr;
}
...
const vk::PhysicalDevicePresentMeteringFeaturesNV& VulkanFeatures::get_present_metering_features_nv() const {
    return m_present_metering_features_nv;
}
VulkanFeatures::operator const vk::PhysicalDevicePresentMeteringFeaturesNV&() const {
    return m_present_metering_features_nv;
}
...
const vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT& VulkanFeatures::get_primitive_restart_index_features_ext() const {
    return m_primitive_restart_index_features_ext;
}
VulkanFeatures::operator const vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT&() const {
    return m_primitive_restart_index_features_ext;
}
...
const vk::PhysicalDeviceQueuePerfHintFeaturesQCOM& VulkanFeatures::get_queue_perf_hint_features_qcom() const {
    return m_queue_perf_hint_features_qcom;
}
VulkanFeatures::operator const vk::PhysicalDeviceQueuePerfHintFeaturesQCOM&() const {
    return m_queue_perf_hint_features_qcom;
}
...
const vk::PhysicalDeviceShaderAbortFeaturesKHR& VulkanFeatures::get_shader_abort_features_khr() const {
    return m_shader_abort_features_khr;
}
VulkanFeatures::operator const vk::PhysicalDeviceShaderAbortFeaturesKHR&() const {
    return m_shader_abort_features_khr;
}
...
const vk::PhysicalDeviceShaderConstantDataFeaturesKHR& VulkanFeatures::get_shader_constant_data_features_khr() const {
    return m_shader_constant_data_features_khr;
}
VulkanFeatures::operator const vk::PhysicalDeviceShaderConstantDataFeaturesKHR&() const {
    return m_shader_constant_data_features_khr;
}
...
const vk::PhysicalDeviceShaderInstrumentationFeaturesARM& VulkanFeatures::get_shader_instrumentation_features_arm() const {
    return m_shader_instrumentation_features_arm;
}
VulkanFeatures::operator const vk::PhysicalDeviceShaderInstrumentationFeaturesARM&() const {
    return m_shader_instrumentation_features_arm;
}
...
const vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE& VulkanFeatures::get_shader_mixed_float_dot_product_features_valve() const {
    return m_shader_mixed_float_dot_product_features_valve;
}
VulkanFeatures::operator const vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE&() const {
    return m_shader_mixed_float_dot_product_features_valve;
}
...
const vk::PhysicalDeviceThrottleHintFeaturesSEC& VulkanFeatures::get_throttle_hint_features_sec() const {
    return m_throttle_hint_features_sec;
}
VulkanFeatures::operator const vk::PhysicalDeviceThrottleHintFeaturesSEC&() const {
    return m_throttle_hint_features_sec;
}
...
const void* VulkanFeatures::get_struct_ptr(vk::StructureType stype) const {
    switch (stype) {
        ...
        case vk::StructureType::ePhysicalDeviceDataGraphModelFeaturesQCOM:
            return &m_data_graph_model_features_qcom;
        case vk::StructureType::ePhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM:
            return &m_data_graph_neural_accelerator_statistics_features_arm;
        case vk::StructureType::ePhysicalDeviceDataGraphOpticalFlowFeaturesARM:
            return &m_data_graph_optical_flow_features_arm;
        ...
        case vk::StructureType::ePhysicalDeviceDescriptorSetHostMappingFeaturesVALVE:
            return &m_descriptor_set_host_mapping_features_valve;
        case vk::StructureType::ePhysicalDeviceDeviceAddressCommandsFeaturesKHR:
            return &m_device_address_commands_features_khr;
        ...
        case vk::StructureType::ePhysicalDeviceFaultFeaturesEXT:
            return &m_fault_features_ext;
        case vk::StructureType::ePhysicalDeviceFaultFeaturesKHR:
            return &m_fault_features_khr;
        ...
        case vk::StructureType::ePhysicalDeviceMaintenance10FeaturesKHR:
            return &m_maintenance10_features_khr;
        case vk::StructureType::ePhysicalDeviceMaintenance11FeaturesKHR:
            return &m_maintenance11_features_khr;
        ...
        case vk::StructureType::ePhysicalDevicePresentIdFeaturesKHR:
            return &m_present_id_features_khr;
        case vk::StructureType::ePhysicalDevicePresentMeteringFeaturesNV:
            return &m_present_metering_features_nv;
        ...
        case vk::StructureType::ePhysicalDevicePresentWaitFeaturesKHR:
            return &m_present_wait_features_khr;
        case vk::StructureType::ePhysicalDevicePrimitiveRestartIndexFeaturesEXT:
            return &m_primitive_restart_index_features_ext;
        ...
        case vk::StructureType::ePhysicalDevicePushConstantBankFeaturesNV:
            return &m_push_constant_bank_features_nv;
        case vk::StructureType::ePhysicalDeviceQueuePerfHintFeaturesQCOM:
            return &m_queue_perf_hint_features_qcom;
        ...
        case vk::StructureType::ePhysicalDeviceShader64BitIndexingFeaturesEXT:
            return &m_shader64_bit_indexing_features_ext;
        case vk::StructureType::ePhysicalDeviceShaderAbortFeaturesKHR:
            return &m_shader_abort_features_khr;
        ...
        case vk::StructureType::ePhysicalDeviceShaderClockFeaturesKHR:
            return &m_shader_clock_features_khr;
        case vk::StructureType::ePhysicalDeviceShaderConstantDataFeaturesKHR:
            return &m_shader_constant_data_features_khr;
        ...
        case vk::StructureType::ePhysicalDeviceShaderImageFootprintFeaturesNV:
            return &m_shader_image_footprint_features_nv;
        case vk::StructureType::ePhysicalDeviceShaderInstrumentationFeaturesARM:
            return &m_shader_instrumentation_features_arm;
        ...
        case vk::StructureType::ePhysicalDeviceShaderMaximalReconvergenceFeaturesKHR:
            return &m_shader_maximal_reconvergence_features_khr;
        case vk::StructureType::ePhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE:
            return &m_shader_mixed_float_dot_product_features_valve;
        ...
        case vk::StructureType::ePhysicalDeviceTextureCompressionAstcHdrFeatures:
            return &m_texture_compression_astchdr_features;
        case vk::StructureType::ePhysicalDeviceThrottleHintFeaturesSEC:
            return &m_throttle_hint_features_sec;
...
bool VulkanFeatures::set_feature(const std::string& feature_name, bool enable) {
    ...
    if (feature_name == "dataGraphNeuralAcceleratorStatistics") {
        m_data_graph_neural_accelerator_statistics_features_arm.dataGraphNeuralAcceleratorStatistics = value;
        return true;
    }
    if (feature_name == "dataGraphOpticalFlow") {
        m_data_graph_optical_flow_features_arm.dataGraphOpticalFlow = value;
        return true;
    }
    ...
    if (feature_name == "deviceAddressCommands") {
        m_device_address_commands_features_khr.deviceAddressCommands = value;
        return true;
    }
    ...
    if (feature_name == "deviceFault") {
        ...
        m_fault_features_khr.deviceFault = value;
        return true;
    }
    if (feature_name == "deviceFaultDeviceLostOnMasked") {
        m_fault_features_khr.deviceFaultDeviceLostOnMasked = value;
        return true;
    }
    if (feature_name == "deviceFaultReportMasked") {
        m_fault_features_khr.deviceFaultReportMasked = value;
        return true;
    }
    if (feature_name == "deviceFaultVendorBinary") {
        m_fault_features_ext.deviceFaultVendorBinary = value;
        m_fault_features_khr.deviceFaultVendorBinary = value;
        return true;
    }
    ...
    if (feature_name == "maintenance11") {
        m_maintenance11_features_khr.maintenance11 = value;
        return true;
    }
    ...
    if (feature_name == "presentMetering") {
        m_present_metering_features_nv.presentMetering = value;
        return true;
    }
    ...
    if (feature_name == "primitiveRestartIndex") {
        m_primitive_restart_index_features_ext.primitiveRestartIndex = value;
        return true;
    }
    ...
    if (feature_name == "queuePerfHint") {
        m_queue_perf_hint_features_qcom.queuePerfHint = value;
        return true;
    }
    ...
    if (feature_name == "shaderAbort") {
        m_shader_abort_features_khr.shaderAbort = value;
        return true;
    }
    ...
    if (feature_name == "shaderConstantData") {
        m_shader_constant_data_features_khr.shaderConstantData = value;
        return true;
    }
    ...
    if (feature_name == "shaderInstrumentation") {
        m_shader_instrumentation_features_arm.shaderInstrumentation = value;
        return true;
    }
    ...
    if (feature_name == "shaderMixedFloatDotProductBFloat16Acc") {
        m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductBFloat16Acc = value;
        return true;
    }
    if (feature_name == "shaderMixedFloatDotProductFloat16AccFloat16") {
        m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat16 = value;
        return true;
    }
    if (feature_name == "shaderMixedFloatDotProductFloat16AccFloat32") {
        m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat32 = value;
        return true;
    }
    if (feature_name == "shaderMixedFloatDotProductFloat8AccFloat32") {
        m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat8AccFloat32 = value;
        return true;
    }
    ...
    if (feature_name == "throttleHint") {
        m_throttle_hint_features_sec.throttleHint = value;
        return true;
    }
...
bool VulkanFeatures::get_feature(const std::string& feature_name) const {
    ...
    if (feature_name == "dataGraphNeuralAcceleratorStatistics") {
        return m_data_graph_neural_accelerator_statistics_features_arm.dataGraphNeuralAcceleratorStatistics == VK_TRUE;
    }
    if (feature_name == "dataGraphOpticalFlow") {
        return m_data_graph_optical_flow_features_arm.dataGraphOpticalFlow == VK_TRUE;
    }
    if (feature_name == "dataGraphShaderModule") {
    ...
    if (feature_name == "deviceAddressCommands") {
        return m_device_address_commands_features_khr.deviceAddressCommands == VK_TRUE;
    }
    if (feature_name == "deviceCoherentMemory") {
    ...
    if (feature_name == "deviceFaultDeviceLostOnMasked") {
        return m_fault_features_khr.deviceFaultDeviceLostOnMasked == VK_TRUE;
    }
    if (feature_name == "deviceFaultReportMasked") {
        return m_fault_features_khr.deviceFaultReportMasked == VK_TRUE;
    }
    if (feature_name == "deviceFaultVendorBinary") {
    ...
    if (feature_name == "maintenance11") {
        return m_maintenance11_features_khr.maintenance11 == VK_TRUE;
    }
    if (feature_name == "maintenance4") {
    ...
    if (feature_name == "presentMetering") {
        return m_present_metering_features_nv.presentMetering == VK_TRUE;
    }
    if (feature_name == "presentModeFifoLatestReady") {
    ...
    if (feature_name == "primitiveRestartIndex") {
        return m_primitive_restart_index_features_ext.primitiveRestartIndex == VK_TRUE;
    }
    if (feature_name == "primitiveTopologyListRestart") {
    ...
    if (feature_name == "queuePerfHint") {
        return m_queue_perf_hint_features_qcom.queuePerfHint == VK_TRUE;
    }
    if (feature_name == "rasterizationOrderColorAttachmentAccess") {
    ...
    if (feature_name == "shaderAbort") {
        return m_shader_abort_features_khr.shaderAbort == VK_TRUE;
    }
    if (feature_name == "shaderBFloat16CooperativeMatrix") {
    ...
    if (feature_name == "shaderConstantData") {
        return m_shader_constant_data_features_khr.shaderConstantData == VK_TRUE;
    }
    if (feature_name == "shaderCoreBuiltins") {
    ...
    if (feature_name == "shaderInstrumentation") {
        return m_shader_instrumentation_features_arm.shaderInstrumentation == VK_TRUE;
    }
    if (feature_name == "shaderInt16") {
    ...
    if (feature_name == "shaderMixedFloatDotProductBFloat16Acc") {
        return m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductBFloat16Acc == VK_TRUE;
    }
    if (feature_name == "shaderMixedFloatDotProductFloat16AccFloat16") {
        return m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat16 == VK_TRUE;
    }
    if (feature_name == "shaderMixedFloatDotProductFloat16AccFloat32") {
        return m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat32 == VK_TRUE;
    }
    if (feature_name == "shaderMixedFloatDotProductFloat8AccFloat32") {
        return m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat8AccFloat32 == VK_TRUE;
    }
    if (feature_name == "shaderModuleIdentifier") {
    ...
    if (feature_name == "throttleHint") {
        return m_throttle_hint_features_sec.throttleHint == VK_TRUE;
    }
    if (feature_name == "tileMemoryHeap") {
...
void* VulkanFeatures::build_chain_for_device_creation(
    ...
    // Group 7: PhysicalDeviceFaultFeaturesKHR and 1 related struct(s)
    if ((m_fault_features_khr.deviceFault == VK_TRUE ||
        m_fault_features_khr.deviceFaultVendorBinary == VK_TRUE ||
        m_fault_features_khr.deviceFaultReportMasked == VK_TRUE ||
        m_fault_features_khr.deviceFaultDeviceLostOnMasked == VK_TRUE) &&
        (physical_device->extension_supported(VK_KHR_DEVICE_FAULT_EXTENSION_NAME))) {
                assert(physical_device->extension_supported(VK_KHR_DEVICE_FAULT_EXTENSION_NAME) &&
                       "Feature enabled but required extension not supported");
        m_fault_features_khr.pNext = chain_head;
        chain_head = &m_fault_features_khr;
    } else {
        if ((m_fault_features_ext.deviceFault == VK_TRUE ||
        m_fault_features_ext.deviceFaultVendorBinary == VK_TRUE) &&
            (physical_device->extension_supported(VK_EXT_DEVICE_FAULT_EXTENSION_NAME))) {
    ...
    // PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM
    if (m_data_graph_neural_accelerator_statistics_features_arm.dataGraphNeuralAcceleratorStatistics == VK_TRUE) {
            assert(physical_device->extension_supported(VK_ARM_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_data_graph_neural_accelerator_statistics_features_arm.pNext = chain_head;
        chain_head = &m_data_graph_neural_accelerator_statistics_features_arm;
    }

    // PhysicalDeviceDataGraphOpticalFlowFeaturesARM
    if (m_data_graph_optical_flow_features_arm.dataGraphOpticalFlow == VK_TRUE) {
            assert(physical_device->extension_supported(VK_ARM_DATA_GRAPH_OPTICAL_FLOW_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_data_graph_optical_flow_features_arm.pNext = chain_head;
        chain_head = &m_data_graph_optical_flow_features_arm;
    }
    ...
    // PhysicalDeviceDeviceAddressCommandsFeaturesKHR
    if (m_device_address_commands_features_khr.deviceAddressCommands == VK_TRUE) {
            assert(physical_device->extension_supported(VK_KHR_DEVICE_ADDRESS_COMMANDS_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_device_address_commands_features_khr.pNext = chain_head;
        chain_head = &m_device_address_commands_features_khr;
    }
    ...
    // PhysicalDeviceMaintenance11FeaturesKHR
    if (m_maintenance11_features_khr.maintenance11 == VK_TRUE) {
            assert(physical_device->extension_supported(VK_KHR_MAINTENANCE_11_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_maintenance11_features_khr.pNext = chain_head;
        chain_head = &m_maintenance11_features_khr;
    }
    ...
    // PhysicalDevicePresentMeteringFeaturesNV
    if (m_present_metering_features_nv.presentMetering == VK_TRUE) {
            assert(physical_device->extension_supported(VK_NV_PRESENT_METERING_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_present_metering_features_nv.pNext = chain_head;
        chain_head = &m_present_metering_features_nv;
    }
    ...
    // PhysicalDevicePrimitiveRestartIndexFeaturesEXT
    if (m_primitive_restart_index_features_ext.primitiveRestartIndex == VK_TRUE) {
            assert(physical_device->extension_supported(VK_EXT_PRIMITIVE_RESTART_INDEX_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_primitive_restart_index_features_ext.pNext = chain_head;
        chain_head = &m_primitive_restart_index_features_ext;
    }
    ...
    // PhysicalDeviceQueuePerfHintFeaturesQCOM
    if (m_queue_perf_hint_features_qcom.queuePerfHint == VK_TRUE) {
            assert(physical_device->extension_supported(VK_QCOM_QUEUE_PERF_HINT_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_queue_perf_hint_features_qcom.pNext = chain_head;
        chain_head = &m_queue_perf_hint_features_qcom;
    }
    ...
    // PhysicalDeviceShaderAbortFeaturesKHR
    if (m_shader_abort_features_khr.shaderAbort == VK_TRUE) {
            assert(physical_device->extension_supported(VK_KHR_SHADER_ABORT_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_shader_abort_features_khr.pNext = chain_head;
        chain_head = &m_shader_abort_features_khr;
    }
    ...
    // PhysicalDeviceShaderConstantDataFeaturesKHR
    if (m_shader_constant_data_features_khr.shaderConstantData == VK_TRUE) {
            assert(physical_device->extension_supported(VK_KHR_SHADER_CONSTANT_DATA_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_shader_constant_data_features_khr.pNext = chain_head;
        chain_head = &m_shader_constant_data_features_khr;
    }
    ...
    // PhysicalDeviceShaderInstrumentationFeaturesARM
    if (m_shader_instrumentation_features_arm.shaderInstrumentation == VK_TRUE) {
            assert(physical_device->extension_supported(VK_ARM_SHADER_INSTRUMENTATION_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_shader_instrumentation_features_arm.pNext = chain_head;
        chain_head = &m_shader_instrumentation_features_arm;
    }
    ...
    // PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE
    if (m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat32 == VK_TRUE ||
        m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat16 == VK_TRUE ||
        m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductBFloat16Acc == VK_TRUE ||
        m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat8AccFloat32 == VK_TRUE) {
            assert(physical_device->extension_supported(VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_shader_mixed_float_dot_product_features_valve.pNext = chain_head;
        chain_head = &m_shader_mixed_float_dot_product_features_valve;
    }
    ...
    // PhysicalDeviceThrottleHintFeaturesSEC
    if (m_throttle_hint_features_sec.throttleHint == VK_TRUE) {
            assert(physical_device->extension_supported(VK_SEC_THROTTLE_HINT_EXTENSION_NAME) &&
                   "Feature enabled but required extension not supported");
        m_throttle_hint_features_sec.pNext = chain_head;
        chain_head = &m_throttle_hint_features_sec;
    }
...
std::vector<const char*> VulkanFeatures::get_required_extensions() const {
    ...
    if (m_data_graph_neural_accelerator_statistics_features_arm.dataGraphNeuralAcceleratorStatistics == VK_TRUE) {
        extensions.insert(VK_ARM_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_EXTENSION_NAME);
    }
    if (m_data_graph_optical_flow_features_arm.dataGraphOpticalFlow == VK_TRUE) {
        extensions.insert(VK_ARM_DATA_GRAPH_OPTICAL_FLOW_EXTENSION_NAME);
    }
    if (m_dedicated_allocation_image_aliasing_features_nv.dedicatedAllocationImageAliasing == VK_TRUE) {
    ...
    if (m_device_address_commands_features_khr.deviceAddressCommands == VK_TRUE) {
        extensions.insert(VK_KHR_DEVICE_ADDRESS_COMMANDS_EXTENSION_NAME);
    }
    ...
    if (m_fault_features_khr.deviceFault == VK_TRUE || m_fault_features_khr.deviceFaultVendorBinary == VK_TRUE || m_fault_features_khr.deviceFaultReportMasked == VK_TRUE || m_fault_features_khr.deviceFaultDeviceLostOnMasked == VK_TRUE) {
        extensions.insert(VK_KHR_DEVICE_FAULT_EXTENSION_NAME);
    }
    ...
    if (m_maintenance11_features_khr.maintenance11 == VK_TRUE) {
        extensions.insert(VK_KHR_MAINTENANCE_11_EXTENSION_NAME);
    }
    if (m_maintenance4_features.maintenance4 == VK_TRUE) {
    ...
    if (m_present_metering_features_nv.presentMetering == VK_TRUE) {
        extensions.insert(VK_NV_PRESENT_METERING_EXTENSION_NAME);
    }
    if (m_present_mode_fifo_latest_ready_features_khr.presentModeFifoLatestReady == VK_TRUE) {
    ...
    if (m_primitive_restart_index_features_ext.primitiveRestartIndex == VK_TRUE) {
        extensions.insert(VK_EXT_PRIMITIVE_RESTART_INDEX_EXTENSION_NAME);
    }
    ...
    if (m_queue_perf_hint_features_qcom.queuePerfHint == VK_TRUE) {
        extensions.insert(VK_QCOM_QUEUE_PERF_HINT_EXTENSION_NAME);
    }
    if (m_rgba10_x6_formats_features_ext.formatRgba10x6WithoutYCbCrSampler == VK_TRUE) {
    ...
    if (m_shader_abort_features_khr.shaderAbort == VK_TRUE) {
        extensions.insert(VK_KHR_SHADER_ABORT_EXTENSION_NAME);
    }
    if (m_shader_atomic_float16_vector_features_nv.shaderFloat16VectorAtomics == VK_TRUE) {
    ...
    if (m_shader_constant_data_features_khr.shaderConstantData == VK_TRUE) {
        extensions.insert(VK_KHR_SHADER_CONSTANT_DATA_EXTENSION_NAME);
    }
    if (m_shader_core_builtins_features_arm.shaderCoreBuiltins == VK_TRUE) {
    ...
    if (m_shader_instrumentation_features_arm.shaderInstrumentation == VK_TRUE) {
        extensions.insert(VK_ARM_SHADER_INSTRUMENTATION_EXTENSION_NAME);
    }
    if (m_shader_integer_dot_product_features.shaderIntegerDotProduct == VK_TRUE) {
    ...
    if (m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat32 == VK_TRUE || m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat16AccFloat16 == VK_TRUE || m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductBFloat16Acc == VK_TRUE || m_shader_mixed_float_dot_product_features_valve.shaderMixedFloatDotProductFloat8AccFloat32 == VK_TRUE) {
        extensions.insert(VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME);
    }
    if (m_shader_module_identifier_features_ext.shaderModuleIdentifier == VK_TRUE) {
    ...
    if (m_throttle_hint_features_sec.throttleHint == VK_TRUE) {
        extensions.insert(VK_SEC_THROTTLE_HINT_EXTENSION_NAME);
    }
    if (m_tile_memory_heap_features_qcom.tileMemoryHeap == VK_TRUE) {
...
std::optional<vk::StructureType> structure_type_for_feature_name(const std::string& name) {
    static const std::unordered_map<std::string, vk::StructureType> name_map = {
        ...
        {"PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM", vk::StructureType::ePhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM},
        {"DataGraphNeuralAcceleratorStatistics", vk::StructureType::ePhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM},
        {"PhysicalDeviceDataGraphOpticalFlowFeaturesARM", vk::StructureType::ePhysicalDeviceDataGraphOpticalFlowFeaturesARM},
        {"DataGraphOpticalFlow", vk::StructureType::ePhysicalDeviceDataGraphOpticalFlowFeaturesARM},
        ...
        {"PhysicalDeviceDeviceAddressCommandsFeaturesKHR", vk::StructureType::ePhysicalDeviceDeviceAddressCommandsFeaturesKHR},
        {"DeviceAddressCommands", vk::StructureType::ePhysicalDeviceDeviceAddressCommandsFeaturesKHR},
        ...
        {"PhysicalDeviceFaultFeaturesKHR", vk::StructureType::ePhysicalDeviceFaultFeaturesKHR},
        {"Fault", vk::StructureType::ePhysicalDeviceFaultFeaturesKHR},
        ...
        {"PhysicalDeviceMaintenance11FeaturesKHR", vk::StructureType::ePhysicalDeviceMaintenance11FeaturesKHR},
        {"Maintenance11", vk::StructureType::ePhysicalDeviceMaintenance11FeaturesKHR},
        ...
        {"PhysicalDevicePresentMeteringFeaturesNV", vk::StructureType::ePhysicalDevicePresentMeteringFeaturesNV},
        {"PresentMetering", vk::StructureType::ePhysicalDevicePresentMeteringFeaturesNV},
        ...
        {"PhysicalDevicePrimitiveRestartIndexFeaturesEXT", vk::StructureType::ePhysicalDevicePrimitiveRestartIndexFeaturesEXT},
        {"PrimitiveRestartIndex", vk::StructureType::ePhysicalDevicePrimitiveRestartIndexFeaturesEXT},
        ...
        {"PhysicalDeviceQueuePerfHintFeaturesQCOM", vk::StructureType::ePhysicalDeviceQueuePerfHintFeaturesQCOM},
        {"QueuePerfHint", vk::StructureType::ePhysicalDeviceQueuePerfHintFeaturesQCOM},
        ...
        {"PhysicalDeviceShaderAbortFeaturesKHR", vk::StructureType::ePhysicalDeviceShaderAbortFeaturesKHR},
        {"ShaderAbort", vk::StructureType::ePhysicalDeviceShaderAbortFeaturesKHR},
        ...
        {"PhysicalDeviceShaderConstantDataFeaturesKHR", vk::StructureType::ePhysicalDeviceShaderConstantDataFeaturesKHR},
        {"ShaderConstantData", vk::StructureType::ePhysicalDeviceShaderConstantDataFeaturesKHR},
        ...
        {"PhysicalDeviceShaderInstrumentationFeaturesARM", vk::StructureType::ePhysicalDeviceShaderInstrumentationFeaturesARM},
        {"ShaderInstrumentation", vk::StructureType::ePhysicalDeviceShaderInstrumentationFeaturesARM},
        ...
        {"PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE", vk::StructureType::ePhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE},
        {"ShaderMixedFloatDotProduct", vk::StructureType::ePhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE},
        ...
        {"PhysicalDeviceThrottleHintFeaturesSEC", vk::StructureType::ePhysicalDeviceThrottleHintFeaturesSEC},
        {"ThrottleHint", vk::StructureType::ePhysicalDeviceThrottleHintFeaturesSEC},
