...
/**
  \class merian::TRangeAllocator

  The merian::TRangeAllocator<GRANULARITY> template allows to sub-allocate ranges from a fixed
...
template <uint32_t GRANULARITY = 256> class TRangeAllocator {
  private:
    uint32_t m_size;
    uint32_t m_used;
