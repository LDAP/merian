...
concept VulkanPropertyStruct = (
    ...
    std::same_as<T, vk::PhysicalDeviceFaultPropertiesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDeviceQueuePerfHintPropertiesQCOM> ||
    ...
    std::same_as<T, vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM> ||
    std::same_as<T, vk::PhysicalDeviceSchedulingControlsPropertiesARM> ||
    std::same_as<T, vk::PhysicalDeviceShaderAbortPropertiesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDeviceShaderInstrumentationPropertiesARM> ||
...
class VulkanProperties {
  public:
    ...
    const vk::PhysicalDeviceFaultPropertiesKHR& get_fault_properties_khr() const;
    operator const vk::PhysicalDeviceFaultPropertiesKHR&() const;
    ...
    const vk::PhysicalDeviceQueuePerfHintPropertiesQCOM& get_queue_perf_hint_properties_qcom() const;
    operator const vk::PhysicalDeviceQueuePerfHintPropertiesQCOM&() const;
    ...
    const vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM& get_scheduling_controls_dispatch_parameters_properties_arm() const;
    operator const vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM&() const;
    ...
    const vk::PhysicalDeviceShaderAbortPropertiesKHR& get_shader_abort_properties_khr() const;
    operator const vk::PhysicalDeviceShaderAbortPropertiesKHR&() const;
    ...
    const vk::PhysicalDeviceShaderInstrumentationPropertiesARM& get_shader_instrumentation_properties_arm() const;
    operator const vk::PhysicalDeviceShaderInstrumentationPropertiesARM&() const;
  ...
  private:
    ...
    vk::PhysicalDeviceFaultPropertiesKHR m_fault_properties_khr{};
    ...
    vk::PhysicalDeviceQueuePerfHintPropertiesQCOM m_queue_perf_hint_properties_qcom{};
    ...
    vk::PhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM m_scheduling_controls_dispatch_parameters_properties_arm{};
    vk::PhysicalDeviceSchedulingControlsPropertiesARM m_scheduling_controls_properties_arm{};
    vk::PhysicalDeviceShaderAbortPropertiesKHR m_shader_abort_properties_khr{};
    ...
    vk::PhysicalDeviceShaderInstrumentationPropertiesARM m_shader_instrumentation_properties_arm{};
