...
concept VulkanFeatureStruct = (
    ...
    std::same_as<T, vk::PhysicalDeviceCooperativeMatrixConversionFeaturesQCOM> ||
    ...
    std::same_as<T, vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM> ||
    std::same_as<T, vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM> ||
    ...
    std::same_as<T, vk::PhysicalDeviceDescriptorHeapFeaturesEXT> ||
    ...
    std::same_as<T, vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDeviceFaultFeaturesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDeviceInternallySynchronizedQueuesFeaturesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDeviceMaintenance11FeaturesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDevicePresentMeteringFeaturesNV> ||
    ...
    std::same_as<T, vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT> ||
    ...
    std::same_as<T, vk::PhysicalDevicePushConstantBankFeaturesNV> ||
    std::same_as<T, vk::PhysicalDeviceQueuePerfHintFeaturesQCOM> ||
    ...
    std::same_as<T, vk::PhysicalDeviceShaderAbortFeaturesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDeviceShaderConstantDataFeaturesKHR> ||
    ...
    std::same_as<T, vk::PhysicalDeviceShaderInstrumentationFeaturesARM> ||
    ...
    std::same_as<T, vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE> ||
    ...
    std::same_as<T, vk::PhysicalDeviceShaderSubgroupPartitionedFeaturesEXT> ||
    ...
    std::same_as<T, vk::PhysicalDeviceThrottleHintFeaturesSEC> ||
...
class VulkanFeatures {
  public:
    ...
    const vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM& get_data_graph_neural_accelerator_statistics_features_arm() const;
    operator const vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM&() const;
    const vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM& get_data_graph_optical_flow_features_arm() const;
    operator const vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM&() const;
    ...
    const vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR& get_device_address_commands_features_khr() const;
    operator const vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR&() const;
    ...
    const vk::PhysicalDeviceFaultFeaturesKHR& get_fault_features_khr() const;
    operator const vk::PhysicalDeviceFaultFeaturesKHR&() const;
    ...
    const vk::PhysicalDeviceMaintenance11FeaturesKHR& get_maintenance11_features_khr() const;
    operator const vk::PhysicalDeviceMaintenance11FeaturesKHR&() const;
    ...
    const vk::PhysicalDevicePresentMeteringFeaturesNV& get_present_metering_features_nv() const;
    operator const vk::PhysicalDevicePresentMeteringFeaturesNV&() const;
    ...
    const vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT& get_primitive_restart_index_features_ext() const;
    operator const vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT&() const;
    ...
    const vk::PhysicalDeviceQueuePerfHintFeaturesQCOM& get_queue_perf_hint_features_qcom() const;
    operator const vk::PhysicalDeviceQueuePerfHintFeaturesQCOM&() const;
    ...
    const vk::PhysicalDeviceShaderAbortFeaturesKHR& get_shader_abort_features_khr() const;
    operator const vk::PhysicalDeviceShaderAbortFeaturesKHR&() const;
    ...
    const vk::PhysicalDeviceShaderConstantDataFeaturesKHR& get_shader_constant_data_features_khr() const;
    operator const vk::PhysicalDeviceShaderConstantDataFeaturesKHR&() const;
    ...
    const vk::PhysicalDeviceShaderInstrumentationFeaturesARM& get_shader_instrumentation_features_arm() const;
    operator const vk::PhysicalDeviceShaderInstrumentationFeaturesARM&() const;
    ...
    const vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE& get_shader_mixed_float_dot_product_features_valve() const;
    operator const vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE&() const;
    ...
    const vk::PhysicalDeviceThrottleHintFeaturesSEC& get_throttle_hint_features_sec() const;
    operator const vk::PhysicalDeviceThrottleHintFeaturesSEC&() const;
  ...
  private:
    ...
    vk::PhysicalDeviceCooperativeMatrixConversionFeaturesQCOM m_cooperative_matrix_conversion_features_qcom{};
    ...
    vk::PhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM m_data_graph_neural_accelerator_statistics_features_arm{};
    vk::PhysicalDeviceDataGraphOpticalFlowFeaturesARM m_data_graph_optical_flow_features_arm{};
    ...
    vk::PhysicalDeviceDescriptorHeapFeaturesEXT m_descriptor_heap_features_ext{};
    ...
    vk::PhysicalDeviceDeviceAddressCommandsFeaturesKHR m_device_address_commands_features_khr{};
    ...
    vk::PhysicalDeviceFaultFeaturesKHR m_fault_features_khr{};
    ...
    vk::PhysicalDeviceInternallySynchronizedQueuesFeaturesKHR m_internally_synchronized_queues_features_khr{};
    ...
    vk::PhysicalDeviceMaintenance11FeaturesKHR m_maintenance11_features_khr{};
    ...
    vk::PhysicalDevicePresentMeteringFeaturesNV m_present_metering_features_nv{};
    ...
    vk::PhysicalDevicePrimitiveRestartIndexFeaturesEXT m_primitive_restart_index_features_ext{};
    ...
    vk::PhysicalDevicePushConstantBankFeaturesNV m_push_constant_bank_features_nv{};
    vk::PhysicalDeviceQueuePerfHintFeaturesQCOM m_queue_perf_hint_features_qcom{};
    ...
    vk::PhysicalDeviceShaderAbortFeaturesKHR m_shader_abort_features_khr{};
    ...
    vk::PhysicalDeviceShaderConstantDataFeaturesKHR m_shader_constant_data_features_khr{};
    ...
    vk::PhysicalDeviceShaderInstrumentationFeaturesARM m_shader_instrumentation_features_arm{};
    ...
    vk::PhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE m_shader_mixed_float_dot_product_features_valve{};
    ...
    vk::PhysicalDeviceShaderSubgroupPartitionedFeaturesEXT m_shader_subgroup_partitioned_features_ext{};
    ...
    vk::PhysicalDeviceThrottleHintFeaturesSEC m_throttle_hint_features_sec{};
